...
namespace cfeApp.Domain
{
    public class CalResistencia: IopeElectrica
    {
        ...
        
        {
            ...
            aux2= $"El valor de esta resistencia {_resultado} y tiene una tolerancia de maxima cuyo valor es {_resultado + aux} y una tolerancia minima cuyo valor es {_resultado - aux}";
            return aux2;
